...
export default function SystemFooter({ isBrutalist }) {
    ...
    return (
        <div className="fixed bottom-0 left-0 w-full bg-[#002244] border-t border-white text-white font-mono text-xs py-1 px-4 flex justify-between uppercase tracking-widest z-50">
